import 'dart:async';
import 'dart:convert';
import 'package:fauna_prototype/models/chat_message.dart';
  ...
  Future<void> fetchPromptResponse(String prompt) async {
    ...
    while (true) {
      ...
      if (runStatus == 'requires_action') {
        ...
        final _submitUrl = 'https://api.openai.com/v1/threads/$_threadId/runs/$runId/submit_tool_outputs'; 
